...
exports.NewsDetailApi = exports.NewsFeedsApi = exports.Api = void 0;
...
function () {
  ...
  Api.prototype.getRequestWithXHR = function (callback) {
    var _this = this;
  ...
  Api.prototype.getRequestWithPromise = function (callback) {
...
/** @class */
function (_super) {
  __extends(NewsFeedsApi, _super);

  function NewsFeedsApi(url) {
    return _super.call(this, url) || this;
  }

  NewsFeedsApi.prototype.getDataWithXHR = function (callback) {
    return this.getRequestWithXHR(callback);
  };

  NewsFeedsApi.prototype.getDataWithPromise = function (callback) {
    return this.getRequestWithPromise(callback);
  };

  NewsFeedsApi.prototype.getData = function () {
    return __awaiter(this, void 0, Promise, function () {
      return __generator(this, function (_a) {
        return [2
        /*return*/
...
exports.NewsFeedsApi = NewsFeedsApi;
...
function (_super) {
  ...
  NewsDetailApi.prototype.getDataWithXHR = function (callback) {
    return this.getRequestWithXHR(callback);
  };

  NewsDetailApi.prototype.getDataWithPromise = function (callback) {
    return this.getRequestWithPromise(callback);
  };
...
function () {
  ...
  View.prototype.addHtml = function (htmlStr) {
    this.htmlArr.push(htmlStr);
  };

  View.prototype.getHtml = function () {
    var snapshot = this.htmlArr.join('');
    this.clearHtmlArr();
    return snapshot;
  };

  View.prototype.clearHtmlArr = function () {
    this.htmlArr = [];
  };
...
function (_super) {
  ...
  function NewsDetailView(rootId, store) {
    var _this = _super.call(this, rootId, template) || this;
...
function (_super) {
  ...
  function NewsFeedView(rootId, list, store) {
    var _this = _super.call(this, rootId, template) || this;
    ...
    _this.render = function (page) {
      ...
      return __awaiter(_this, void 0, Promise, function () {
        var _a, _b, listCnt, maxList, maxPage, i, _c, id, title, comments_count, points, time_ago, user, read;

        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              if (!!this.store.hasFeed) return [3
              /*break*/
              , 2];
            ...
            case 2:
              ...
              listCnt = this.store.numberOfFeed;
              maxList = this.store.currentPage * this.list > listCnt ? listCnt : this.store.currentPage * this.list;
              maxPage = Math.ceil(listCnt / this.list);

              for (i = (this.store.currentPage - 1) * this.list; i < maxList; i++) {
                _c = this.store.getFeed(i), id = _c.id, title = _c.title, comments_count = _c.comments_count, points = _c.points, time_ago = _c.time_ago, user = _c.user, read = _c.read;
              ...
              this.setTemplate('next_page', String(this.store.currentPage == maxPage ? this.store.currentPage : this.store.nextPage));
              this.updateView();
              return [2
              /*return*/
              ];
...
var newsFeedView = new page_1.NewsFeedView('root', 8, store);
